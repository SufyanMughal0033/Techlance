...
function PortfolioVisual({
  ...
  return (
    <div className="relative aspect-[4/3] w-full overflow-hidden rounded-md border border-border bg-surface-2">
      ...
      <span className="absolute left-6 top-6 z-10 h-2 w-2 rotate-45 bg-accent transition-transform duration-500 ease-premium group-hover:rotate-[135deg]" />

      <span
        aria-hidden="true"
        className="absolute bottom-4 right-6 z-10 font-display text-[3.5rem] font-semibold leading-none tracking-tightest text-ink/[0.08] transition-colors duration-500 group-hover:text-accent/[0.16]"
      >
        {num}
      </span>
    </div>
